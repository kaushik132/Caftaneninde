...
<div class="lg:w-[700px] w-full pb-14 lg:mx-auto text-center lg:mt-20 mt-44 border-[#D5D5D5] lg:border rounded-md pt-14 px-4 bg-white shadow-sm animate-zoomIn">
  <div class="relative w-fit mx-auto">
    <img class="lg:w-[100px] w-[65px] mx-auto animate-bounceIn" src="{{url('images/check-mark.png')}}" alt="Success">
  </div>
  ...
  <div class="lg:mt-10 mt-7 flex flex-wrap justify-center gap-3">
    <a href="{{url('account')}}" class="border border-[#FF71A8] px-10 lg:py-2.5 py-2 text-[#FF71A8] text-[13px] lg:text-[15px] font-bold inline-block rounded-md hover:bg-[#FFE1ED] transition-all">
      View Order
    </a>
